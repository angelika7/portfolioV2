    ...
    constructor(props) {
        ...
        this.state= {
            projects: [
                ...
                {id: 1, url: url9, alt: 'Foto 2', info: 'Strona internetowa -', title: '"Portfolio v2.0"', isFlipped: false, backInfo: `${check} React.js ${check} CSS3 (SCSS) ${check} JS ${check} GSAP ${check} Webpack 4`, live: '.', github: '.', isActive: true},
